...
{
    [Header("Scene References")] public string sceneAssetName;
    public int sceneIndexInBuildSettings;

    [Header("Level Settings")] public int maxBaseHealth = 100;
    public int startingCurrency = 100;
    public Wave[] waves;
    [Tooltip("in seconds")] public float timeBetweenWaves = 10f;

    [Header("UI")] public Sprite thumbnail;

    [Header("Other")] public bool isUnlocked;
